...
public class MainClass {
	public static void main(String[] args) {
		...
		Weapon w1=(Weapon)context.getBean("myWeapon");	//bean을 생성하면서 bean의 이름을 적는다
...
// 그래서 의존하고 있는(import해서 사용하고 있는) 클래스는 뭔가 수정사항이 생기면 그 클래스 자체를 수정해야 하는 일이 생기지만, (유지&보수 관점에서 클래스 수정은 커다란 일이다.)
// spring을 이용해서 인터페이스 타입을 받아 사용하는 클래스는 xml파일만 수정해주면 된다. 


// [의존관계를 느슨하게 하는 방법]    
// 핵심 의존 객체를 직접 new 하지 않기(import하지 않고)
// 스프링 프레임 워크에 맞기기
// 인터페이스 타입을 적극 활용하기