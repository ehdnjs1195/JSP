...
public class ShowFortuneServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		pw.println("<link rel='stylesheet' href='/Step01_Servlet/resources/css/bootstrap.css'/");		//bootstrap을 사용하고 싶으면
		pw.println("</head>");
		pw.println("<body>");
		pw.println("<div class='container'>");
			pw.println("<p>오늘의 운세는?! 두구두구두구두구... </br> <strong>강~동!원!</strong> 이군요?!</p>");
