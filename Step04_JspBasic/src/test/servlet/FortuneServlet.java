...
public class FortuneServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//1. 응답을 위임할 이동 경로 (context path 는 넣지 않는다. why? 같은 프로젝트 내에서만(같은 context 내에서만) forward 이동이 가능하기 때문이다. 이미 context path를 포함한 것이다.)
		...
		//forward를 사용하는 이유: servlet에서는 html의 복잡한 마크업을 하기 힘들기 때문에 나머지 복잡한 처리는 servlet에서 하고 응답은 jsp에 맡기겠다 그런 모습.
