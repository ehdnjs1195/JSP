...
<p> 10 은 2 보다 커요 : <strong>${10 gt 2 }</strong></p> 	<%-- greater than --%>
<p> 10 은 2 와 같거나 커요 : <strong>${10 >= 2}</strong></p>
<p> 10 은 2 와 같거나 커요 : <strong>${10 ge 2}</strong></p> 	<%-- greater or equal --%>
<p> 10 은 2 보다 작아요 : <strong>${10 < 2 }</strong></p>
<p> 10 은 2 보다 작아요 : <strong>${10 lt 2 }</strong></p> <%-- least than --%>
<p> 10 은 2 와 같거나 작아요 : <strong>${10 <= 2 }</strong></p>
<p> 10 은 2 와 같거나 작아요 : <strong>${10 le 2 }</strong></p> <%-- least or equal --%>
<p> 10 은 10 과 같아요 : <strong>${10 == 10 }</strong></p>
<p> 10 은 10 과 같아요 : <strong>${10 eq 10 }</strong></p>  <%-- equal --%>
<p> 10 은 10 과 달라요 : <strong>${10 != 10 }</strong></p>
<p> 10 은 10 과 달라요 : <strong>${10 ne 10 }</strong></p>  <%-- not equal --%>
